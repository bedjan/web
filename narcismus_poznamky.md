...
## <span class="c11">Brzké indikace narcistické poruchy osobnosti</span>
...
<!-- end list -->
  ...
  - <span class="c3">mnoho odborníků v oblasti mentálního zdraví jsou
    narcisti</span>
...
### <span class="c0">Citová vazba</span>
...
<span class="c6">Narcistické rodičovství</span>
...
## <span class="c11">Narcismus a morálka</span>
  ...
  - <span class="c3">pokud by bylo narcistovo skutečné já umístěno mezi
    ...
    udržovat své falešné já, čímž se chová v souladu se se svými
...
#### <span class="c16">Narcismus jako důsledek globalizace a rozpadu společenských struktur</span>
...
#### <span class="c16">Narcis vs. Psychopat (anti-sociální porucha osobnosti)</span>
  ...
  - <span class="c3">psychopati nejsou schopni udržovat dlouhodobé
    ...
    že se narcisovi a jeho cílům podřidí, bude podporovat jeho
...
## <span class="c11">Dělení dle struktury osobnosti</span>
...
#### <span class="c16">Skrytý narcis v kostce</span>
  ...
  - <span class="c3">Neodpouští a stále přemítá nad tím, jak mu kdo
    ublížil.</span>
  - <span class="c3">Dominantními emocemi je stud, úzkost, nenávist,
...
<span class="c19">Vztahy s druhými</span>
  ...
  - <span class="c3">Nenávidí autority, rady, společenská pravidla -
...
#### <span class="c16">Invertovaný narcis jako podtyp skrytého narcise</span>
  ...
  - <span class="c3">Jsou vyděšení z toho ukázat ostatním, že jim jde o
...
### <span class="c0">Somatický narcis</span>
...
#### <span class="c16">Nejzávažnější - Psychopatický tyran</span>
...
# <span class="c18">Osobnostní dynamika narcise</span>
...
### <span class="c0">Co je to falešné já?</span>
...
### <span class="c0">Obranné mechanismy</span>
  ...
  - <span class="c3">narcisti si vyvíjí obrany - nezodpovědné chování,
...
## <span class="c11">Narcistní přísun = narcisova droga</span>
...
#### <span class="c16">Sekundární zdroje</span>
...
### <span class="c0">Zajištění a idealizace zdrojů přísunu</span>
  ...
  - <span class="c3">dokud je člověk zdrojem přísunu, vše v pořádku,
...
### <span class="c0">Možná řešení nedostatku narcistického přísun</span>
...
### <span class="c0">Extenze patologického narcistického prostoru</span>
...
## <span class="c11">Narcis a emoce</span>
  ...
  - <span class="c3">narc jsou hypersenzitivní co se týče emocí, ale
...
## <span class="c11">Narcis a životní situace</span>
...
### <span class="c0">Chladná empatie</span>
  ...
  - <span class="c3">narcis pozoruje veškeré lidské chování a ukládá je
    do obrovské heuristické databáze, a následně dle těchto heurestik
    imituje emoční chování lidí v situacích, které si toto žádají</span>

### <span class="c0">Vztahové vlastnosti</span>

#### <span class="c16">Nezájem o lidi = lidé jako objekty přísunu</span>

  - <span class="c3">Lidé jsou pro narcise jen objekty, zdroje
    přísunu</span>
  - <span class="c3">Narcis nemá přátele v pravém slova smyslu - život
    narcise je jen a pouze o zajišťování narcistního přísunu</span>
  - <span class="c3">Absence empatie způsobuje, že ostatní jsou pro
    narcise výrazně méně zajimaví, než pro běžné lidi se schopností
    empatie, proto se narcisové o lidi moc nezajímají</span>
  - <span class="c3">Narcista je predátor  a není schopen socializace -
    vnímá jen sebe jako člověka, ostatní jsou pro něj jen prostředky pro
    konzumaci narcistického přísunu.</span>
  - <span class="c3">narcisté nejsou hloupí (rozumí mnoha na inteligenci
    náročným věcem), ale v oblasti mezilidských vztahů a potřeb jsou
    technicky řečeno buď idioti nebo debilové(=narcisti)</span>

#### <span class="c16"> Roztříštěná osobnost narcise</span>

  - <span class="c3">Narcis je slepeninou vícero osobností a je
    ultimátním měňavcem.</span>
  - <span class="c3">Narcis je prostorově a časově nesouvisející</span>
  - <span class="c3">Se svými dřívějšími podobami se již neidentifikuje
    a cítí se nespravedlivě nařčen za svou minulost, na což reaguje
    narcistickým hněvem.</span>
  - <span class="c3">Narcis není schopen vnímat vztah mezi jeho chováním
    v minulosti a současným stavem záležitostí.</span>
  - <span class="c3">Po příchodu do nového prostředí narcis zkouší různé
    osobnosti a hledá tu, které maximalizuje přísun z dostupných
    zdrojů.</span>
  - <span class="c3">Většina narcisových osobností je uložena v mražáku
    a není součástí jeho aktuální identity</span>
  - <span class="c3">V případě návratu do známého prostředí dochází k
    okamžitému odmražení osobnosti asociované s daným místem</span>

#### <span class="c16">Prevence emoční účasti + vztahová neflexibilita</span>

  - <span class="c3">Narcis nejprve nadhodnocuje, následně podhodnocuje,
    zavrhuje a opouští lidi</span>
  - <span class="c3">Ostatní nejsou ochotni tolerovat jeho výkyvy nálad,
    chaotický život jako na horské dráze. Chvíli je to fajn, ale
    dlouhodobě je to ostatním nepříjemné.</span>
  - <span class="c3">Narcis je přecitlivělý - jeho nitro je domeček z
    karet - musí proto reagovat na byť jen sebemenší hrozbu své vnitřní
    rovnováhy a proto raději zůstává doma, nedělá nic odvážného,
    nepokouší se překonat hranice svého komfortu.</span>
  - <span class="c3">V případě pseudofunkční společenské integrace
    používá taktiky bránící emoční účast - chová se rigidně, neustále
    se opakuje, je předvídatelný, nudný, baví se jen o záležitostech
    týkajících se ho samotného. V případě konfrontace s neznámými
    situacemi nebo byť jen minimálními námitkami a odporem hystericky
    zuří.</span>

#### <span class="c16">Narcis a intimita</span>

  - <span class="c3">Lidi s obavami z intimity se bojí z důvodu rizika
    odhalení jejich nedostatků, ztráty kontroly a taktéž se bojí potřeby
    závazku souvisejícího s intimitou</span>
  - <span class="c3">Tyto obavy odkazují na nedůvěru ve svět a druhé
    lidi - poukazují na přesvědčení, že svět je nehostinné prostředí a
    budoucnost není přátelská a věci se mohou jen zhoršit</span>
  - <span class="c3">Katastrofizace vztahu může být i obrácená - já jsem
    ten, co vše a všechny zničí a zkazí (externí vs. interní centrum
    kontroly)</span>
  - <span class="c3">Člověk se strachem z intimnosti je hyper-ostražitý
    nebo paranoidní, pochybující o vlastní schopnosti soudit druhé lidi
    a realitu</span>
  - <span class="c3">Narcis je tzv. “Ambivalentní” - touží po lásce a
    společnosti a zároveň se lásky a společnosti obává</span>
  - <span class="c3">Narcis se obává intimity, protože intimita =
    závislost na konkrétní osobě  = riziko zranění danou osobou =
    riziko disintegrace narcise</span>
  - <span class="c3">Z tohoto důvodu narcis svého partnera preventivně
    opouští jako první tím, že odmítá intimitu, aby mohl následně v
    případě potřeby tvrdit, že to byl právě on kdo zavrhl partnera.
    Absence intimity zároveň pomáhá narcisovi vyrovnat se s kognitivní
    disonancí plynoucí ze závislosti na podřadné osobě.</span>
  - <span class="c3">Narcis i jeho partner se tak snaží zůstat co nejvíc
    zaneprázdnění, aby se intimitě vyvarovali - mohou cestovat každý
    sám, být workoholiky, podvádět s jinými</span>
  - <span class="c3">Narcis i jeho partner se vzájemně trápí a týrají -
    v přítomnosti týrání není prostor pro intimitu</span>
  - <span class="c3">Týrání navíc umožňuje cítit se ve vztahu špatně,
    což je dobrá výmluva pro podvádění, závislosti atd.</span>
  - <span class="c3">Vztah s člověkem bojícím se intimity je extrémně
    zmatečný - čím víc se partner přibližuje, tím víc se člověk bojící
    se intimity vzdaluje. tento cyklus pokračuje neustále donekonečna a
    nemůže nikdy vyústit v dobrý konec.</span>

#### <span class="c16">Konfliktní vztahy</span>

  - <span class="c3">Narcis se vztahuje k ostatním prostřednictvím
    neuzavřených konfliktů</span>
  - <span class="c3">Napětí plynoucí z konfliktů poskytuje narcisovi
    energii, pomáhá mu zůstat pozorný a bdělý.</span>
  - <span class="c3">Bez konstantního aktivního konfliktu není schopen
    udržet dostatečnou úroveň mentálního nabuzení. </span>

### <span class="c0">Narcisovy vztahy</span>

#### <span class="c16">Narcisův vztah s rodiči</span>

  - <span class="c3">Narcis potřebuje své rodiče jako sekundární zdroj
    přísunu - jde o nejdéle přetrvávající zdroj přísunu v jejich
    životě</span>
  - <span class="c3">Pokud narcis nevyřeší svůj traumatický vztah se
    svými rodiči před tím než umřou, degradují po jejich smrti opět do
    role dítěte</span>

#### <span class="c16">Narcis a přátelé</span>

  - <span class="c3">Narcisové obecně nemají přátelé v pravém slova
    smyslu</span>
  - <span class="c3">Příkladem narcistického přátelství jsou přátelství
    postav jako Sherlock Holmes nebo detektiv Poirot</span>
  - <span class="c3">Oba jsou narcisti a schizoidi, uzavřeni ve svých
    domovech zabráni do samotářských aktivit</span>
  - <span class="c3">Vyhýbají se soupeření se sobě rovnými, považují se
    však za nebojácné a nemající konkurenci</span>
  - <span class="c3">Mají své blízké pomocníky kteří jim slouží jako
    obecenstvo a pochlebovači, podporující jejich grandiozitu bez
    toho</span>
  - <span class="c3">Tito pomocníci musí být zároveň dostatečně
    intelektuálně schopní, aby nemohli být narcisem považování na
    idioty.</span>
  - <span class="c3">Narcisové své pomocníky na veřejností často
    poniží.</span>

### <span class="c0">Narcis a dysfunkční rodina</span>

#### <span class="c16">Rodina jako kult</span>

  - <span class="c3">dysfunkční rodiny fungují velmi podobně jako kulty
      - mozky členů jsou vymyty, následně jsou rozděleny role, při
        porušení pravidel se aplikují tresty…</span>
  - <span class="c3">narcisové tvoří kulty. své potřeby nedokáží naplnit
    jinak než pozorností lidí. ostatní se snaží přesvědčit, že jejich
    virtuální realita je ta pravá realita, zatímco reality jejích obětí
    nejsou skutečné.</span>
  - <span class="c3">narcis se snaží konvertovat všechny kolem sebe na
    jeho náboženství, na uznávání jeho falešného já, stejně jako
    on</span>
  - <span class="c3">někdy je v kultu jen manželka, někdy pětičlenná
    rodina, někdy 500 zaměstnanců někde celé země, jako v nacistickém
    německu</span>
  - <span class="c3">narcisové byli první lidé, kteří žili ve virtuální
    realitě, a to ještě mnohem dříve, než někdo termín virtuální reality
    vymyslel</span>
  - <span class="c3">vše je nevědomé, nepřiznané, nediskutované,
    neodhalené... ale stále dokola a dokola prožívané. je to pro nás
    normální a zdá se, že věci jsou tak jak mají být. Jsou prostě tak
    jak jsou.</span>
  - <span class="c3">Narušení rodinné fasády z fikce a iluzí je
    považováno za smrtelný hřích a hříšník bude okamžitě vystaven
    vážnému a přetrvávajícímu emočnímu týrání, obviňování a
    potenciálně také fyzickému týrání, což se často děje v rodinách,
    kde je přítomno sexuální zneužívání.</span>
  - <span class="c3">Zrada rodiny je nechtěným vedlejším efektem
    atmosféry zamlčování a falešnosti - narcisův partner nebo jeho
    dospělé děti často využívají narcisovy zranitelnosti jako
    prostředky rebelie proti narcisovi. </span>
  - <span class="c3">První co se v narcisově rodině zhroutí je sdílená
    psychóza - rodinné popírání a zamlčování, které bylo pečlivě a
    potají v rodině narcisem kultivováno.</span>

#### <span class="c16">Dysfunkční rodina</span>

  - <span class="c3">dysfunkční rodiny nikdy nemají dostatek - nemají
    dostatek lásky, zdravé komunikace, přijetí, sebeúcty.... ale rodina
    musí něco konzumovat aby přežila, takže konzumuje nezdravé emoční
    vzorce</span>
  - <span class="c3">dysfunkční rodina se požírá navzájem. rodina se
    vnitřně emočně kanibalizuje a tento emoční kanibalismus přenáší z
    generace na generaci, resp. se mezigeneračně požírá</span>

#### <span class="c16">Narcis a manželství</span>

  - <span class="c3">i přes strach závazků a intimity narcisté uzavírají
    sňatky, dokonce opakovaně a velmi rychle (čímž se snaží ukázat
    ostatním, že oni jsou vpořádku a jejich bývalý zatím rozvedený
    partner je ten v nepořádku)</span>
  - <span class="c3">manželství je pro narcise prostor pro kontrolu -
    kontrolu partnera, peněz, majetku, citů partnera.... a zároveň
    záruka, že nebudou sami a nebudou se muset dívat na sebe takové,
    jací ve skutečnosti jsou.</span>
  - <span class="c3">manželství je tedy permanentním zdrojem
    narcistického přísunu</span>
  - <span class="c3">láska nikdy nemůže být důvodem ke sňatku - vždy
    musí být nějaký jiný důvod, který narcis vnímá jako výhodu v jeho
    dalším vykořisťování světa pro své vlastní potřeby</span>
  - <span class="c3">pokud se zeptáte narcise co miluje na svém
    partnerovi, tak nejspíš odpoví něčím z toho, co pro něj partner
    dělá, nikoliv tím, jaký je partner jako člověk v širší
    společnosti</span>

#### <span class="c16">Narcis a spoluzávislý</span>

  - <span class="c3">Vztah narcise a spoluzávislého je nejsmutnější ze
    všech příběhů</span>
  - <span class="c3">healthy individuals have narcissistic barometer /
    intuition - the charm will wear thin in a few months of close
    relationship</span>
  - <span class="c3">codependent need therapy after relationship with
    narcissist, otherwise they go back to the same narcissist or other
    narcissist</span>
  - <span class="c3">setting up boundary with a narcissist causes the
    narcissist a narcissistic injury</span>

## <span class="c11">Životní styl narcise</span>

### <span class="c0">Osobní život, zájmy, aktivity a osobní rozvoj narcise</span>

  - <span class="c3">Lidé se často podivují nad rozdílem mezi veřejným a
    soukromým životem známých osobností - jakoby měli dvě osobnosti -
    skutečnou, která je rezervována výhradně pro ty nejbližší a
    falešnou, kterou se prezentují na veřejnosti</span>
  - <span class="c3">Narcista nemá žádný soukromý život - narcista
    existuje jen skrze pozornost ostatních</span>
  - <span class="c3">Narcis nemá skutečné trvalé zájmy, lásky, koníčky.
    má rád jen to co v daný moment produkuje maximum naristního
    přísunu.</span>
  - <span class="c3">Cyklus idealizace-znehodnocení-odhození se
    projevuje také v oblasti zájmů a aktivit a tvoří iluzi osobního
    růstu</span>

<!-- end list -->

  - <span class="c3">po sepsání článku přijde narcisovi jeho článek
    dokonalý, bezchybný</span>
  - <span class="c3">Po pár týdnech je však již celý špatně</span>
  - <span class="c3">Narcis si toto odůvodňuje tak, že se rozvíjí a
    posouvá a neuvědomuje si, že konstantně idealizuje a
    znehodnocuje</span>
  - <span class="c3">Narcis věří, že s dostatkem času a úsilí dosáhne na
    své idealizované falešné já, i přestože si uvědomuje, že toto
    falešná já je zatím falešné.</span>

<!-- end list -->

  - <span class="c3">Narcis není schopen osobního růstu (a související
    smysluplné práce s terapeutem), protože nedokáže odpovídat na otázky
      - nechce si připomínat své chyby a omyly, resp. odkrývat cestu k
        jejich skutečnému já, ke kterým by se člověk mohl dostat
        prostřednictvím jejich odpovědi</span>
  - <span>Narcis tak nikdy nepřijde k terapeutovi s listem problémů,
    které chce vyřešit tak, že se v něčem změní nebo zlepší</span>

### <span class="c0">Kompenzatorní vs Destabilizující přístup</span>

<span class="c6">Kompenzatorní přístup</span>

  - <span class="c3">narcis izoluje jeden nebo více aspektů života a ty
    stabilizuje - pomocí peněz, vlivu, statusu, strachu. </span>
  - <span class="c3">Mění zaměstnání, koníčky, náboženské víry atd. ale
    celou dobu udržuje vztah s jednou ženou a dokonce jí zůstává věrný.
    </span>
  - <span class="c3">Žena je jeho ostrovem stability, zatímco vše
    ostatní může být v chaosu. Žena tedy kompenzuje.</span>
  - <span>Podobně kariérní narcista - vše je v chaosu kromě jeho
    kariéry.</span>

<span class="c6">Destabilizující přístup</span>

  - <span class="c3">Narcis zvyšuje nestabilitu v jedné oblasti
    zvyšováním nestability v dalších oblastech. </span>
  - <span class="c3">Při rezignaci nebo výpovědi se zároveň přestěhuje.
    při rozvodu zároveň dá výpověď v práci. </span>
  - <span class="c3">Toto mu dává pocit, že probíhá transformace a že
    jeho život se mění.</span>

### <span class="c0">Cyklus hyper-aktivity a hypo-aktivity</span>

  - <span class="c3">cyklus je důsledkem jemných fluktuací v toku
    přísunu ze zdrojů</span>
  - <span>Narozdíl od bipolární poruchy jsou tyto cykly reaktivní,
    jednoduše přiřaditelné k vnějším spouštěčům - zdrojům narcistického
    přísunu</span>

<span class="c6">Hyperaktivita / signalizace</span>

  - <span class="c3">spoustu nápadů, grandiózních plánů, charismatický,
    vůdčí.... často insomniak, plny energie... kreativní, výborný
    manažer, společenský</span>

<span class="c6">Hypoaktivita / hibernace</span>

  - <span class="c3">depresivní, bez energie, pesimistický, tráví čas v
    posteli, nezajímá ho jak vypadá a působí na ostatní, je asociální,
    uzavírá se do sebe pryč od ostatních</span>
  - <span class="c3">narcis akumuluje energii, zkoumá terén a zjišťuje,
    jaký zdroj a jaký signal bude nejvhodnější pro efektivní využití
    manického cyklu k zajištění nejlepšího zdroje potěšení</span>
  - <span class="c3">na konci hybernačního cyklu vysílá narcista signál
      - rozesílá dopisy a žádosti o spolupráci, obléká si oblečení, ve
        kterém vypadá dobře atd.</span>

## <span>Životní příběh narcise</span>

### <span class="c0">Konstantní krize středního věku</span>

  - <span class="c3">Narcis je v konstantní krizi středního věku</span>

<!-- end list -->

  - <span class="c3">nemá nic, na co by se mohl těšit</span>
  - <span class="c3">Nemá možnost druhé šance</span>
  - <span class="c3">Nemá žádné sny</span>

<!-- end list -->

  - <span class="c3">Někteří se regenerují, změní svůj život a jdou
    dále. Někteří zahořknou a stanou se z nich peciválové.</span>
  - <span class="c3">Konstantní krize středního věku je způsobena
    rozdílem mezi ambicemi a realitou</span>
  - <span class="c3">Proto aby se narcis vyhýbal konstantní krizi, dělá
    svůj život co nejvíc nepredikovatelný</span>

### <span class="c0">Neúspěch v zaměstnání</span>

  - <span class="c3">nevyhýbá se práci obecně, vyhýbá se jen tomu, v čem
    nevidí přínos v podobě narcistického přísunu</span>
  - <span class="c3">Narcis věří v artistickou inspiraci, věří že svět
    je jeho plátnem, nevěří v pot a dřinu.</span>
  - <span class="c3">život často dotlači narcisty do zaměstnání
    strukturovaných negativně vůči jejich potřebám, střídají zaměstnání
    a pravidelně se sebedestruktivními činy z těchto zaměstnání
    diskvalifikují</span>
  - <span class="c3">Narcis opouští zaměstnání, protože ho už ostatní
    nemohou vystát nebo protože byl narcisticky zraněn</span>
  - <span class="c3">Postupem času odhozen všemi kolem, kolegy i rodinou
      - nachází se nezaměstnaný a nezaměstnatelný. i pokud mu je
        nabídnuta pozice, dělá vše proto, aby ji nezískal - je pasivně
        agresivní a negativistický.</span>
  - <span class="c3">šťastnější narcisté, jež nemusí pracovat se cítí
    taktéž neschopně, protože nerealizovali své sny být tak bohatí a
    mocní, jak si zaslouží.</span>

### <span class="c0">Příčiny neúspěchu</span>

  - <span class="c3">entitlement + arogance/conviction of superiorirty +
    aversion of routine</span>
  - <span class="c3">mají pocit, že nepotřebují tituly a školy</span>
  - <span class="c3">nenávidí repetitivní metodický dlouhodobý krok za
    krokem přístup. chtějí aby se děly zázraky.</span>
  - <span class="c3">narcisté chtějí všechno hned a tady</span>
  - <span class="c3">z tohoto důvodu nejsou schopni se dlouhodobě se
    smysluplně věnovat rodině, nebo rozvoji podnikání, nebo  životě na
    jednom místě, nebo dokončit univerzitní studia, nebo bydlet či
    pracovat dlouho na jednom místě nebo akumulovat bohatství
    apod.</span>
  - <span class="c3">pokud narcis dělá dokola stále to samé, tak se
    dostane do deprese, zaspává, přejídá se, pije a dostává se do
    bezhlavých činností, čímž generuje vzrušení v životě.</span>
  - <span class="c3">odmítání návyků je součástí agresivního
    entitlementu. není čas stát v řadě, nebo plnit domácí povinnosti,
    když je možné dělat více záživnější věci.</span>
  - <span class="c3">odmítání rutiny je taktéž sebeprotekčním
    mechanizmem, bránícím tvorbě emoční vazby a možného souvisejícího
    emočního zranění.</span>
  - <span class="c3">toto vede k opakujícím se cyklům
    idealizace-znehodnocení-odhození, kdy narcis opakovaně přistupuje a
    následně se vyhýbá k osobám, návykům atd.</span>

### <span class="c0">Stáří narcise</span>

  - <span class="c3">Obvykle končí svůj život osamělý, zahořklý,
    lehkomyslný, lůzr.</span>

# <span class="c18">Zhoršující se stav narcise</span>

## <span class="c11">Společenská izolace narcise</span>

### <span class="c0">Cesta ke společenské izolaci</span>

  - <span class="c3">Mnoho narcisů skončí o samotě, protože za sebou
    spálili všechny mosty a nepodařilo se jim chytit do pasti žádného
    spoluzávislého</span>
  - <span class="c3">typické pro narcisty bez peněz, harému a dalším
    zdrojů přísunu - narcis se s přibývajícím věkem stává horším a
    horším člověkem, obzvláště pokud se jim nedaří vyprodukovat
    zvětšující se množství zdrojů přísunu</span>
  - <span class="c3">Narcis se stáhne, emočně a sociálně se odpojí a
    uzavře se ve svém světě fantazií a halucinací a nechá se jimi plně
    pozřít</span>

### <span class="c0">Rozvoj schizoidní osobnosti</span>

  - <span>Izolace narcise od společnosti způsobuje symptomy schizoidní
    osobnosti</span>

<!-- end list -->

  - <span class="c3">ztráta touhy po blízkých vztazích jakéhokoliv
    druhu</span>
  - <span class="c3">ztráta zájmu o sex s druhým člověkem</span>
  - <span class="c3">preference aktivit bez dalších lidí</span>
  - <span class="c3">absence blízkých přátel a bližních s výjimkou
    nejbližší rodiny</span>
  - <span class="c3">aktivity nezpůsobují potěšení</span>
  - <span class="c3">emoční chlad, odstup, afektivita</span>
  - <span class="c3">myšlení nekonzistentní s dominantní kulturou</span>
  - <span class="c3">podivně stereotypizované myšlení a mluva</span>
  - <span class="c3">Potřeba robotických a omezujících rutin a návyků
    jakožto způsobu života</span>
  - <span class="c3">Povrchí a sami sebou absorbování</span>
  - <span class="c3">Neschopní reagovat na společenské signály</span>
  - <span class="c3">přehnané vysvětlování</span>
  - <span class="c3">podezřívání a paranoia</span>

<!-- end list -->

  - <span class="c3">Stávají se z nich počítačoví hackeři, fyzikové
    apod.</span>
  - <span class="c3">Žijí prostřednictvím robotických </span>
  - <span class="c3">V případě stresu se plně desintegrují</span>

## <span class="c11">Kolaps narcise</span>

### <span class="c0">Dekompozice / Disintegrace</span>

  - <span class="c3">psychologický fenomén, kdy se člověk zhroutí a
    rozpadá v důsledku stresu a neúspěchu, v případě narcise z důvodu
    neschopnosti zajistit si jakýkoliv narcistický přísun</span>
  - <span class="c3">v případě narcismu navíc ještě navíc fenomén
    "herectví" - když se z narcise díky absenci narcistických ochranných
    štítů vynořuje prostřednictvím dětských záchvatů vzteku množství
    agrese a nahromaděných negativních emocí.</span>
  - <span class="c3">Narcis, který prošel dekompozičním kolapsem je
    úplně sám, snaží se pomstít všem, které viní za svůj pád a je
    ochoten opustit svůj současný život a začít úplně nanovo.</span>
  - <span class="c3">pouze ve stavu kdy je narcis všemi opuštěn a zažívá
    kompletní rozpad všech svých obran cítí své skutečné emoce, kterým
    se snažil celý život za každou cenu vyhnout</span>
  - <span class="c3">je naprosto sám, existenčně, nikoliv jen
    pocitově</span>
  - <span class="c3">celý svět působí nereálně, jako noční můra</span>
  - <span class="c3">cítí se buď plně vinný nebo viní za vše někoho
    jiného</span>
  - <span class="c3">brzy se však zotavuje, uniká do nového
    psychosexuálního vztahu, nachází si nové předměty pro uspokojení,
    jeho rány se rychle zahojí</span>

### <span class="c0">Narcis a sebevražda</span>

  - <span>často ideace o sebevraždě, ale téměř nikdy se o ni nepokusí
    (pokus o sebevraždu a sebepoškozování je položkou diferenční
    diagnózy mezi BPD a NPD)</span>

## <span class="c11">Narcis a terapie</span>

#### <span class="c16">Terapie jako reakce na krizi</span>

  - <span class="c3">2 možné reakci na krizi - terapie nebo alternativní
    zdroje přísunu</span>
  - <span class="c3">Lidé obecně chodí na terapii až po té, co se
    dostali na úplné dno - jít na terapii je pro lidi definitivním
    přiznáním si neúspěchu.</span>

#### <span class="c16">Narcis v běžné psychoterapii</span>

  - <span class="c3">povídací terapie pro narcise nefunguje - narcis
    postupně vysaje terapeuta, takže narcis preferuje hledat další
    zdroje</span>
  - <span class="c3">narcis v terapii typicky nemá zájem zjišťovat, jak
    vnitřně funguje a nefunguje a jak se příště vyhnout tomu, kam se
    nyní dostal. typicky se zajímá o tipy a triky jak obnovit své
    falešné já, jak získat zpět život, který kdysi měl.</span>
  - <span class="c3">v terapii lze modifikovat narcistická chování tak,
    aby byly pro okolí společensky přívětivé a akceptovatelné</span>

#### <span class="c16">        Chladná terapie - další vývoj terapie narcismu</span>

  - <span class="c3">důvod proč jsme nebyli schopni vyléčit narcismus je
    protože jsme ho špatně koncipovali a snažili se vyléčit něco co
    neexistuje.</span>
  - <span class="c3">Chladná terapie - narcis musí být opakovaně
    traumatizován stejným způsobem jako byl traumatizován jako dítě, aby
    si mozek uvědomil, že opakující se trauma přežije a že tedy není
    potřeba narcistické obrany.</span>
  - <span class="c3">narcismus je trauma, vývojová porucha promíšená s
    poruchou citové vazby v dětství = nelze používat metody
    psychoterapie pro dospělé, je třeba používat metody psychoterapie
    pro děti\!</span>
  - <span class="c3">Narcismus je komplexní post-traumatickou stresovou
    poruchou, nejedná se o poruchu osobnosti</span>
  - <span class="c3">Narcismus je třeba léčit jako trauma, což dává
    naději - víme velmi dobře jak léčit trauma, naproti tomu vůbec
    netušíme jak léčit poruchy osobnosti</span>
  - <span class="c3">K narcisovi je třeba přistupovat jako k dítěti,
    nikoliv jako k dospělému.</span>
  - <span class="c3">Narcis musí být vnímán jako dvě osobnosti, nikoliv
    jako jedna osobnost.</span>

# <span class="c18">Narcistické týrání a zneužívání</span>

## <span class="c11">Peníze - narcisův nejoblíbenější nástroj manipulace</span>

### <span class="c0">Vztah narcise k penězům</span>

  - <span class="c3">peníze jsou pro narcise jeho nejoblíbenějším
    nástrojem</span>
  - <span class="c3">bez peněz v bance se narcis cítí obnažen, s penězi
    má svobodu a pohodu být sám se sebou, arogantně nadřazený nad masy
    opovržení hodných lidí</span>
  - <span class="c3">navzdory běžným představám narcis málokdy používá
    peníze k zajištění si přízně. často je schovává a udržuje v
    tajnosti.</span>
  - <span class="c3">mnoho narcisů nosí staré oblečení, nemají auto,
    nemají majetek a to často i když jsou bohatí.</span>
  - <span class="c3">někteří narcisté jsou štědří, někteří nadměrně
    utrácejí, někteří s penězi hrají a spekulují... všichni jsou však
    nenasytitelní - chcou stále víc.</span>
  - <span class="c3">narcista však po penězích netouží ani je jako
    takové nepotřebuje. pro narcise jsou peníze zdrojem síly a svolením
    k jeho chování.</span>
  - <span class="c3">Narcisův vztah k penězům je sadistický - je o
    smrti, nikoliv o životu</span>
  - <span class="c3">jakmile je narcista bez peněz, stává se spasitelem
    lidu, je dobročinný, bojuje proti všemu zlému včetně narcismu. snaží
    se tak získat pozornost. chovat se takto dlouhodobě je pro narcise
    však neudržitelné a potřebuje získat peníze k tomu, aby mohl opět
    týrat a mít zálohy na uspokojování své závislosti v případě
    krize.</span>

### <span class="c0">Funkce peněz z pohledu narcise</span>

  - <span class="c3">peníze jsou pro narcise povolenkou k hříchům a
    odpoutávají bestii k tomu, aby byla svobodná a sama sebou</span>
  - <span class="c3">peníze umožňují narcisovi být sám sebou -
    manipulativní, sadistický</span>
  - <span class="c3">peníze umožňují narcisovi vyhýbat se skutečnému
    životu a týrat bez omezení - dovolují narcisovi být to nejhorší co
    může být</span>
  - <span class="c3">narcista potřebuje vědět, že má peníze na to
    pořídit si alternativy pro případ, že by přišel o své zdroje
    přísunu v důsledku toho jak je týrá</span>

### <span class="c0">Finanční závislost na narcisovi</span>

  - <span class="c3">oběti závislé na narcisových penězích jsou
    spoutanými loutkami v narcisově divadelním představení</span>
  - <span class="c3">oběti musí trpět množstvím sebeklamu, kognitivní
    disonance, aby si zdůvodnili oběť, kterou dělají v oblasti sebeúcty
    a  vnímání reality proto, aby zůstaly na narcisově výplatní
    pásce</span>
  - <span class="c3">sebeuvědomování však není daleko pod povrchem a
    oběti si uvědomují, že jsou oběťmi a buď rebelují kontra-dependencí
    nebo se podřizují a stávají se spoluzávislými</span>
  - <span class="c3">pokud oběti neutečou včas, přejímají narcisovy
    vzory chování a stávají se součástí jeho sdílené psychózy</span>

### <span class="c0">Peníze jako nástroj</span>

  - <span class="c3">peníze používá jako zbraň v případě, kdy jste s ním
    přerušili kontakt</span>
  - <span class="c3">narcis jako rodič používá peníze jako nástroj, jako
    páku, jako cukr a bič, jako vodítko, kterým uvzují ostatní k
    sobě</span>
  - <span class="c3">To kam až je narcista schopen zajít pro peníze je
    nechutné. Ćím víc vyjebou s ostatními, tím lépe se cítí.</span>

### <span>Peníze a rodina</span>

  - <span class="c3">narcis často zneužívá své vnoučata tím, že jim
    vsadí do hlavy to, že jim něco odkáže - často se tak snaží jít
    proti vůli svých dětí, které se snaží své děti držet od narcise v
    bezpečné vzdálenosti nebo úplně bez kontaktu - je třeba opravdu
    důsledně bránit kontaktu - narcis bude hledat způsob, jak se k
    vnoučatům dostat</span>
  - <span class="c3">při rozvodu s narcisem je třeba, aby rozvodový
    právník měl zkušenosti s narcisty, jinak není šance přiblížit se k
    férovému vypořádání (narcis zašije a schová peníze jinde)</span>
  - <span class="c3">narcista typicky odkazuje své peníze svému zlatému
    dítěti a nic nebo neporovnatelně málo ostatním dětem. Toto je jejich
    finální akt týrání - používají i svou smrt k tomu, aby
    ublížili.</span>

## <span class="c11">\>\>\> Narcistické týrání a zneužívání \\\<\\\<\\\<</span>

  - <span class="c3">všichni narcisové týrají - někteří verbálně,
    někteří přílišnou upřímností nebo brutálním humorem…</span>
  - <span class="c3">zneužívání a týrání je jakékoliv chování, díky
    kterému je rodící se osobnost dítěte a jeho osobní hranice
    narušovány rodiči, nebo dalšími opatrovníky, případně vzory a v
    extrémních případech vrstevníky</span>
  - <span class="c3">své zdroje narcis netýrá, dokud mu poskytují
    přísun. jakmile však chcou dělat něco po svém nebo jakmile něco
    narcisovi vyčtou, jsou narcisem vnímání jako překážka, stávají se
    pro něj úhlavním nepřítelem (splitting) a jsou týrání</span>
  - <span class="c3">narcisové týrají obzvláště ty, se kterými by měli
    být intimní</span>
  - <span class="c3">týrají redukuje úzkost z toho, že budou opuštěni -
    jako zneužívající se cítí nadřazeně zneužívaným</span>
  - <span class="c3">narcis předpokládá, že bude opuštěn - vztahy se
    totiž často rozpadají. proto je pro něj lepší, aby to byl právě on
    kdo toho docílí, kdo toto způsobí, díky čemuž ho to následně nezraní
    tolik, jako by mu to udělali druzí a udrží si svou kontrolu nad svým
    životem a nad druhýma lidma. </span>
  - <span class="c3">zneužívání je také způsobem výchovy podřízeného,
    které ve většině případů funguje - většina týraných modifikuje své
    chování, aby byli co nejméně týrání</span>

### <span class="c0">Smear Campaign</span>

  - <span class="c3">většina lidí si myslí, že narc je dobrý člověk a
    nikdy by neudělal nic špatného</span>

### <span class="c0">Modifikace chování okolí</span>

  - <span>Narcissists, Disagreement and Criticism</span>

### <span class="c0">Cyklus idealizace, znehodnocení a odhození</span>

  - <span class="c3">narcis idealizuje zdroje svého uspokojení, protože
    čím lepší mu připadají, tím lépe vnímá sám sebe, za to, že je to
    právě on kdo má tak skvělé zdroje. to vede k přehnané idealizace a
    k přehnané valuaci zdrojů.</span>
  - <span class="c3">pokud však potom zdroje byť v nejmenším zklamou,
    díky své neschopnosti uznat chybu ve svém ohodnocení jsou tyto
    zdroje vnímány naprosto opačně - adekvátně předchozí pozitivní
    idealizaci, tentokrát však v negativním světle - toto je velmi
    bolestivé jak pro narcise tak pro zdroj přísnu</span>

### <span class="c0">Recyklace zdrojů (“hoovering”)</span>

  - <span class="c3">narc se snaží recyklovat a získat zpět odhozené
    zdroje v případě, kdy nemá dostatek jiných zdrojů</span>
  - <span class="c3">pro to, aby narcista kontaktoval znova tento zdroj,
    je třeba jej re-idealizovat, ale zároveň zachovat narativ,
    prostřednictvím kterého byl zdroj posledně odhozen - např. “sice mě
    zranila, ale myslela to dobře”... nebo “sice je naivní a hloupá, ale
    díky tomu je skutečná a autentická”</span>

# <span class="c18">Děti v rodině narcise</span>

## <span class="c11">Narcistický rodič a děti</span>

  - <span class="c3">Mít děti jako osoba s NPD by mělo být postaveno
    mimo zákon, protože z podstaty fungování narcise je zaručeno, že
    děti budou zneužívány - jako zdroj narcistického přísunu a jako
    extenze narcise.</span>
  - <span class="c3">Narcis je vždy lepší než všichni kolem, obzvláště
    pak jeho děti nemohou být nikdy tak dobří jako on.</span>
  - <span class="c3">Na pocitech dětí nezáleží, jde o to jak se budou
    cítit narcističtí rodiče.</span>
  - <span class="c3">Narcis je přesvědčen o tom, že jeho děti musí být
    schopny zvládnout stejné, nebo dokonce ještě větší utrpení než
    zvládl on, a proto do jejich života prostřednictvím vlastního
    týrání reprodukuje své vlastní dětské trauma</span>
  - <span class="c3">Narcis může s dítětem splynout - tlačit ho k
    úspěchu, který narcis potřebuje pro své potěšení, nebo o děti
    nejeví zájem - závidí jejich úspěchy.</span>
  - <span class="c3">Dítě je dokonalým sekundárním zdrojem narcistního
    přísunu, takže narcis se snaží dítě manipulovat tak, aby navždy
    zůstalo jeho dítětem, obzvláště pak pokud dítě rebeluje nebo se
    usiluje o vlastní nezávislost.</span>
  - <span class="c3">Pokud narcistní matka plánuje svatbu pro svou
    dceru, dcera hraje pouze vedlejší podpůrnou roli, ve skutečnosti
    matka plánuje svatbu pro sebe, což je obzvláště viditelné, pokud
    něco nakonec nejde podle jejího plánu a ona běsní a zuří, zatímco
    dcery se daný problém nijak výrazně nedotýká.</span>

### <span class="c0">Reakce narcise na rozšíření rodiny o nového člena</span>

  - <span class="c3">narcis se cítí ohrožen příchodem nového člena
    rodiny - vnímá jej jako nepřítele, se kterým musí bojovat o zdroje
    svého narcistického přísunu</span>
  - <span class="c3">narcis se snaží asimilovat nebo monopolizovat
    nového člena a nachází způsob jak získat z nového člena narcistické
    potěšení - např. tak, že je používá jako proxy, skrz kterou si
    přenáší dítětem získanou pozornost na sebe</span>
  - <span class="c3">Následně se narcisův přístup naprosto otáčí a své
    děti nadhodnocuje a idealizuje a snaží se získat si přízeň svých
    dětí, snaží se vyobrazit sebe jako skvělého a úžasného otce a
    vtáhnout do této psychózy i své vlastní děti. v tomto okamžiku se
    snaží narcis plnými silami přetransformovat své dítě ve zdroj jeho
    vlastního přísunu a riziko všech forem zneužívání je v tento okamžik
    nejvyšší.</span>
  - <span class="c3">postupem času nový člen rodiny objeví a osvojí
    anti-narcistická chování a narcis reaguje znehodnocováním a
    odhozoením. kritika přicházející od dospívajícího dítěte bouřící se
    proti tomu, jak se k němu narcis choval vrací narcise zpět na
    začátek cyklu a začíná vnímat vlastní dítě jako hrozbu, odtahuje
    se, ztrácí veškerý zájem, je odtažitý a chladný,
    nekomunikuje.</span>
  - <span class="c3">narcisův rozklad pokračuje - je v úzkých, stává se
    paranoidním. cítí se zatlačený do rohu, je klaustrofobický, dusí se
    a nejradši by utekl a zbavil se všech svých závazků vůči těm, kteří
    se pro něj stali naprosto neužiteční, nebo ho dokonce zraňují.
    nechápe, proč by je měl podporovat nebo dokonce trpět v jejich
    přítomnosti. rebeluje buď pasivně-agresivně nebo agresivně.
    Později se dostává do paranoidních stavů, kdy je přesvědčen o tom,
    že členové rodiny konspirují proti němu a snaží se ho omezovat,
    nerozumí mu, nebo mu chtějí ublížit.</span>
  - <span class="c3">Nakonec dostane to co chtěl - rodina kterou stvořil
    se rozpadá a mu je to buď líto, protože jeho hnízdo narcistického
    přísunu se rozpadlo, nebo pociťuje úlevu a je pozitivně překvapen
    tím, že svět je opravdu tak krutý, jak si jej představoval, a že
    lidé se chovají skutečně tak, jak od nich vždy očekával.</span>

### <span class="c0">Obranné reakce dětí narcise</span>

  - <span class="c3">děti se odpojí od rodičů a najdou si alternativní
    rodiče - vychování babičkou apod.</span>
  - <span class="c3">vyvíjí falešné já a stávající se narcisy</span>
  - <span class="c3">traumatická vazba - Stockholmský syndrom - dítě se
    stává extenzí rodiče, uspokojuje rodiče, někdy dokonce jedná jako
    rodič rodiče, a stává se na rodiči závislým pro mnohé psychické a
    mentální funkce. později se stává spoluzávislým.</span>

### <span>Pravidla v </span> <span>r</span> <span class="c0">odině narcise</span>

  - <span class="c3">Narcistické rodiny operují prostřednictvím
    nevysloveného souboru pravidel</span>
  - <span class="c3">Děti se naučí tyto pravidla dodržovat, ale nikdy v
    nich nemají jasno, jsou jimi zmatené a prožívají bolest a utrpení,
    protože tyto pravidla zamezují emočnímu přístupu k jejich
    rodičům</span>
  - <span class="c3">Tyto pravidla umožňují rodičům fungovat bez
    vymezených hranic ve vztahu ke svým dětem, díky čemuž je používají
    nebo zneužívají tak, jak se jim zrovna hodí.</span>
  - <span class="c3">Děti se stávají neviditelné, nevyslyšené,
    neopečovávané.</span>

<span class="c6">Příklady pravidel</span>

  - <span class="c3">změn realitu - přetvařuj se, aby věci vypadaly
    respektuhodnější</span>
  - <span class="c3">s rodiči mluv vždy s respektem a nikomu neříkej, co
    se u nás doma děje</span>
  - <span class="c3">vždy se chovej a jednej jako dospělý - potřeby
    rodičů jsou důležitější než potřeby děti</span>
  - <span class="c3">rodiče vysílají nejasné signály - mám Tě ráda, ale
    teď běž pryč... nebo dítě donese otci kafe, otec poděkuje, ale
    věnuje pozornost televizi namísto toho, aby dával lásku
    dítěti</span>
  - <span class="c3">máš zakázáno cítit a projevovat city - např. když
    umře zvířátko a dítě brečí a je smutné a otec nadává, že je slaboch,
    aby byl silný a přestal řvát - omezení emoční exprese je jeden z
    hlavních důvodů, proč mají děti z dysfunkčních rodin mentální nemoci
    jako dospělí</span>
  - <span class="c3">přesvědčují dítě, že svět je nebezpečný, že je
    lepší neseznamovat se s neznámýma lidma, že je lepší nelézt na
    nebezpečné průlezky, stromy apod., protože se může stát něco
    špatného - dítě je pak ze všeho vyděšené, není schopno dělat nic
    nového, na vše se přehnaně připravuje a očekává, že mu hrozí
    nebezpečí a že mu bude ublíženo</span>
  - <span class="c3"> rodiče očekávají, že dítě bude neustále dokonalé,
    jinak jej nelze milovat. buď jsi hloupý, nebo jsi dokonalý - dítě je
    vyděšené dělat cokoliv nového, protože ví, že nebude dokonalé</span>
  - <span class="c3">není dovoleno dělat žádné chyby</span>

## <span class="c11">Polarizace vztahů s dětmi v rodině narcise</span>

### <span class="c0">Polarizace vztahů s dětmi</span>

  - <span class="c3">Polarizace vztahů s dětmi je důsledkem omezeného
    množství narcistických obranných a kompenzačních mechanismů</span>
  - <span class="c3">Narcis není schopen tvořit koherentní obrázek z
    protichůdných vjemů a pomocí polarizace rozděluje svět na černý a
    bílý, dobrý a špatný, buď a nebo. </span>
  - <span class="c3">V důsledku tohoto obranného psychického mechanismu
    je minimálně jedno z dětí ignorováno, nebo v horším případě aktivně
    pasováno do role obětního beránka, neboli černé ovce rodiny. V
    případě vícečlenné rodiny se jedno z dětí stává tzv. Zlatým
    dítětem, ostatní děti se typicky (pokud to rodinná dynamika
    dovoluje) stávají obětní beránky.</span>
  - <span class="c3">Vyhranění rolí mezi zlatým dítětem a obětním
    beránkem může být v určitých rodinných konfiguracích poměrně
    flexibilní a narcis mění přiřazení rolí podle toho, jak ho které z
    dětí zrovna uspokojuje.</span>
  - <span class="c3">Narcista se vyhraňuje vůči jednomu dítěti jakožto
    problémovému, aby si získal přízeň druhého dítěte. Musí to udělat,
    aby se mohl cítit dobře - potřebuje projektovat své chyby a špatné
    vlastnosti na okolí. Narcis projektuje svou dobrou část na své zlaté
    dítě a svou špatnou část na obětního beránka.</span>
  - <span class="c3">Narcista potřebuje nenávidět, projektovat krutost a
    zraňovat, vidět bolest v tváři někoho jiného než sebe.</span>
  - <span class="c3">Narcis vidí dobré pozitivní stránky těch mu
    nejbližších a pokaždé když je vidí, tak je musí utlačovat, protože
    ví, že sám takový nikdy být nemůže. Toto dělá i na účet vlastních
    potomků i na účet partnerů, kterým přísahal lásku.</span>
  - <span class="c3">Život dětí v rodině s narcisem je jako život s
    nacistickým SS - děti jsou neustále podrobovány kontrole a narcis s
    oblibou opakovaně narušuje soukromí dětí, hledá a popichuje dokud
    nejde něco nevhodného, něco zakázaného a pokud náhodou nic nenajde,
    tak si něco vymyslí a obviní dítě. všechny děti potom žijí v
    neustálé úzkosti a panice z toho, aby právě ony nebyly dalším
    cílem narcisova hněvu, pochybuji o sobě a cítí se
    nedostatečně.</span>
  - <span class="c3">Cílem narcise je zničit svobodné vnímání reality
    dětí a přepsat ho vlastním vnímáním reality.</span>

### <span class="c0">Zlaté Dítě</span>

  - <span class="c3">Narcis používá zlaté dítě jako zdroj pozitivního
    narcistního přísunu - projektuje na něj své dobré vlastnosti, snaží
    se ho utvořit k obrazu svému.</span>
  - <span class="c3">Dítě je opečováváno tak, aby se v něm narcis
    vzhlížel a cítil se dobře.</span>
  - <span class="c3">Zlaté dítě se má dobře, dostává to nejlepší,
    cokoliv nevhodné co udělá je skryto, uklizeno, nebo přebarveno na
    něco pozitivního.</span>
  - <span class="c3">Zlaté dítě mělo vše - bylo chráněno proti právnímu
    systému, bylo mu pomáháno s jeho dluhy za gambling, bylo mu pomáháno
    v případě, že bylo obviněno ze zločinu. I přesto vše o něm rodiče
    mluví pozitivně, zatímco obětní beránek je ponižován a
    zatracován.</span>

<span class="c3"></span>

  - <span class="c3">Narcis potřebuje zlaté dítě jako dítě, se kterým
    jezdí na dovolené, za kterým jezdí na víkendové návštěvy a kterým se
    proklamuje jako dobrý rodič</span>
  - <span class="c3">Zlaté dítě je předváděno okolí jako úspěch snažení
    rodičů</span>
  - <span class="c3">Zlaté dítě dává životu narcisty smysl a opravňuje
    jeho existenci</span>

<span class="c3"></span>

  - <span class="c3">Pokud narcis ztratí své zlaté dítě, chřadne až do
    smrti</span>
  - <span class="c3">Narcistický rodič potřebuje zachovat vztah se
    zlatým dítětem za každou cenu - je to důležitý zdroj narcistického
    přísunu, včetně budoucího extra-důležitého zdroje přísunu ve formě
    vnoučat</span>

<span class="c3"></span>

  - <span class="c3">2 osudy zlatých dětí - buď pochopí, že jsou
    zneužívány a utečou (výjimečně) nebo se stanou narcisty (většina
    případů)</span>
  - <span class="c3">Pokud narcista nemá peníze, zlaté dítě s nima
    typicky nechce mít nic do činění a utíká.</span>
  - <span class="c3">Někdy dokáže dítě narcistického rodiče idealizovat
    natolik, že je vůči jeho narcismu slepé a považuje jej za skvělého
    rodiče.</span>

### <span class="c0">Obětní Beránek / Černá Ovce</span>

  - <span class="c3">Obětní beránek slouží jako oběť pro přenos viny a
    jako koncentrace problémů pro odchýlení pozornosti od ostatních
    problémů v rodině</span>
  - <span class="c3">Cokoliv co udělají není nikdy dostatečné dobré,
    dokonce i dobročinnost a charitativní chování je vnímáno jako něco
    nepatřičného</span>
  - <span class="c3">Vždy je třeba někoho obvinit, pokud narcis někoho
    neobviní, riskuje, že bude obviněn on sám.</span>
  - <span class="c3">Obětní beránek schytává obvinění a je mu
    připomínáno vše, co špatného se v rodině, resp. životě narcise,
    děje.</span>

<span class="c3"></span>

  - <span class="c3">Obětní beránek je většinou více citlivý,
    psychologicky vnímavý, intuitivní, kreativní, autistický a má v
    důsledku dysfunkce rodiny největší proklivitu k rozvoji mentálních
    nemocí.</span>
  - <span class="c3">Vždy hledá pravdu, zaobírá se pochopením reality.
    Typicky empaticky vnímaví, velmi brzo si uvědomí, že něco není v
    pořádku.</span>
  - <span class="c3">Obětním beránkům realita situace obvykle dojde
    dřív, protože jejich realita je v každém okamžiku nejnepříjemnější
      - málokdy dostávají pozornost, návaly lásky, a nejsou idealizování
        tak jako zlaté dítě.</span>

<span class="c3"></span>

  - <span class="c3">Partner narcise je vždy obětním beránkem, ostatní
    lide se často stávají obětními beránky situačně, minimálně jedno z
    dětí se taktéž stává obětním beránkem.</span>
  - <span class="c3">Cítí se bezcenně, často trpí naučenou bezmocností,
    často tropí scény, nepřijímají odpovědnost, stávají se závislými,
    končí se školou, zaměstnáním a ztotožňuji se s svým naprogramováním
    špatného dítěte. Trpí depresí, úzkostí a velkým zklamáním ze
    života.</span>

<span class="c3"></span>

  - <span class="c3">Obětní beránek je konstantním zdrojem narcistikých
    zranění, vyvolávající v narcisovi zuřivost, závist, potřebu
    ponižovat.</span>
  - <span class="c3">Beránek se škrábe na hlavě, kroutí hlavou a
    nerozumí tomu, jak se může v rodině dít to co se v ní děje.</span>
  - <span class="c3">Obětní beránek hlásá  “císař je nahý\!”, za což je
    následně (nejen) císařem potrestán.</span>
  - <span class="c3">Obětní beránci jsou svědci, kterých se narcis
    podobně jako mafie zbavuje.</span>

### <span class="c0">Proces polarize dětí do jejich rolí</span>

  - <span class="c3">Typicky starší dítě se stává obětním beránkem,
    nejspíš proto, že starší dítě je "bezpečnostní kamerou" narcisovy
    rodiny - je si nejvíc vědomý narcisových chyb a nedostatků a
    souvisejících důsledků narcisova zneužívání na rodinu a proměnu
    osobnostní jednotlivých členů rodiny</span>
  - <span class="c3">Mladší dítě je pozadu s vývojem mozku a vnímá
    chování rodičů jakožto vždy správné, zatímco obětní beránek již
    vidí problémy a protestuje. Mladšímu dítěti tak přijde špatné
    chování ze strany rodičů opodstatněné a způsobené obětním beránkem,
    který tudíž musí být špatný, protože rodiče jsou dobří.</span>
  - <span class="c3">Instinkt dítěte se navíc snaží zajistit, aby dítě
    bylo rodiči milováno, proto se k nim přiklání, i přestože rodiče
    týrají staršího sourozence.</span>
  - <span class="c3">Zlaté dítě se instinktivně bude přibližovat k
    narcistickému rodiči a obohacovat jeho život, zatímco se od něj učí
    schopnosti přežití ve světě  - ponižování, znehodnocování,
    ubližování... </span>
  - <span class="c3">Zlaté dítě neví, že je zlaté dítě, jednoduše se
    snaží přežít. Nerozumí narcismu, ale ví že je tím, které je
    milováno, které je oslavováno, zatímco sourozenec je ten špatný,
    vidí co se děje, když se černá ovce staví rodině a nechce s tím mít
    nic společného.</span>

<span class="c3"></span>

  - <span class="c3">Obětní beránek se naučí vyrovnávat se s
    narcistickým týráním izolací, vyhýbáním se času s rodiči a útěkem
    do vlastní fantazie (knihy, hudba, filmy, počítačové hry
    atd.)</span>
  - <span class="c3">Mladší dítě si v určitý okamžik (cca uprostřed
    puberty)  uvědomí, že je oblíbenějším dítětem, že toho dostává od
    rodičů víc a ví co musí dělat pro to, aby si tuto přízeň
    udrželo.</span>
  - <span class="c3">Mladší dítě vidí, že protestovat se nevyplácí a že
    získává víc z toho co potřebuje, když protestovat nebude a spolčí se
    s narcisem proti protestování černé ovce rodiny.</span>
  - <span class="c3">V rodině lze pozorovat, jak zaměření na zlaté dítě
    stoupá, zatímco zaměření na obětního beránka klesá</span>

<span class="c3"></span>

  - <span class="c3">Narcis se snaží držet zlaté dítě a obětní beránky
    tak daleko od sebe jak jen je to možné, aby spolu nekomunikovali, a
    aby se zlaté dítě nikdy nedozvědělo pravdu.</span>
  - <span class="c3">Zlaté dítě se distancuje od svých sourozenců a plně
    se soustředí na získání rodičovského přijetí a rodinného
    dědictví.</span>
  - <span class="c3">Postupem času zlaté dítě přebírá narcisovy způsoby
    fungování a jako odrůstající náctiletý se vědomě rozhoduje toto
    přijmout za své, i přestože ví, že jde o špatná chování, kterými
    zraňuje své sourozence s tím, že myslí převážně na své přežití, na
    peníze které tím získá, na auto které tím získá, na zajištění pro
    své potomky které tím získá.</span>
  - <span class="c3">Ztrácí empatii, sympatii, soudnost. Jediné o co jim
    jde je zůstat číslo 1 ve svém světě, cítí se privilegovaně a stávají
    se plným narcisem.</span>
  - <span class="c3">Timto narcistický rodič v alianci se zlatým dítětem
    dokončuje přenosový cyklus narcismu z generace na generaci.</span>

### <span class="c0">Důsledky polarize na vzájemné vztahy dětí</span>

  - <span class="c3">Na začátku je sourozenec vzdálený, bez empatie, bez
    starosti... což vede postupně k oddělení.</span>
  - <span class="c3">Po dlouhodobé aplikaci polarizačních metod se
    postupem času se vztah mezi dětmi úplně vytrácí.</span>
  - <span class="c3">Ať už obětní beránek dosáhne čehokoliv a udělá
    cokoliv, zlaté dítě ho nikdy nepřijme.</span>
  - <span class="c3">Sourozenci budou vždy proti obětnímu beránkovi,
    protože byli prostřednictvím rodičovského vzoru od dětství
    vychovávány k tomu, jak se k tomuto sourozenci chovat.</span>

<span class="c3"></span>

  - <span class="c3">Újma způsobena narcistickou triangulací je tak
    velká, že zlaté dítě naprosto nenávidí černou ovci, která vůbec
    nechápe, proč ho jeho sourozenec takto nesnáší.</span>
  - <span class="c3">Újma je často tak hluboká, že zlaté dítě není ani
    schopno mluvit o tom, kvůli čeho svého sourozence nenávidí.</span>
  - <span class="c3">Další narcis je zrozen a užívá si utrpení svých
    sourozenců, které je nyní schopen také způsobovat.</span>

<span class="c3"></span>

  - <span class="c3">Obětní beránek prožívá zlost - ví kde je problém,
    ale nedokáže s tím nic dělat, ztrácí (dalšího) člověka, kterého
    hluboce miloval a čekal, že on jej miloval taktéž.</span>
  - <span class="c3">Narcis odvedl svou práci tak dobře, že ze zlatého
    dítěte se stal plnohodnotný narcis, s pocity nenávisti zakořeněnými
    tak hluboko, že je téměř nemožné je prolomit a i přes logické
    pochopení situace nezbývá obětnímu beránkovi nic jiného, než
    přerušit kontakt i se svým zlatým sourozencem.</span>

### <span class="c0">Životní osudy dětí</span>

  - <span class="c3">Rozdělení rolí zlatého dítěte a obětního beránka
    zůstává z pohledu rodiny navždy vytesána do kamene.</span>
  - <span class="c3">Ve výjimečných případech se stává, že sourozenci
    pochopí co se dělo, sjednotí se a pomohou si v osamostatnění
    se.</span>
  - <span class="c3">V 9 z 10ti případů se zlaté dítě stává plným
    narcistou, nebo demonstruje množství narcistických chování -
    společně s rodičem narcisem často  zneužívá a skrytě nenávidí
    narcisova partnera (svou matku/otce)</span>
  - <span class="c3">Děti, které se nestanou narcisty trpí
    spoluzávislostí.</span>

<span class="c3"></span>

<span class="c6">Problémy dětí</span>

  - <span class="c3">Neustále přehrávání záblesků minulosti v mysli,
    nedostatek znalostí o tom, jak normálně fungovat jako dospělý ve
    vztahu</span>
  - <span class="c3">Děti trpí celoživotní vnitřní samotou v důsledku
    dětství v rodině s neustále vyhrocenýma emocema nebo absencí emoční
    blízkosti.</span>
  - <span class="c3">Mnoho dospělých dětí narcistů neví jak se vypořádat
    s následky týrání, obrací svou pozornost k alkoholu, drogám, ženám a
    často po třicítce ukončují svůj život, často protože jejich
    narcismus není plně vyvinut a nedokáže se tak chránit proti
    přicházejícím psychologickým zraněním</span>
  - <span class="c3">Obětní beránek není v dospělosti schopen projevovat
    své pravé emoce (např. absence jasné emoční reakce při přebírání
    dárku), což následně vyžaduje spoustu introspekce a terapie.</span>
  - <span class="c3">Žijeme životy v emoční chudobě a nedostatku a
    nacházíme si vztahy, které replikují to, co jsme zažívali jako
    děti</span>
  - <span class="c3">Jedna z nejhorších věcí, kterou lze po dlouhé době
    věznění, omezování a týrání udělat je dát takovému člověku v jeden
    okamžik plnou svobodu a odpovědnost. Po konci občanské války v US se
    mnoho bývalých otroků rozhodlo být dále otroky a vrátili se s
    prosíkem zpět s přáním mít nazpět svou submisivní roli.</span>

<span class="c3"></span>

### <span class="c0">Metody polarizace</span>

  - <span class="c3">Polarizace a týrání</span>

<!-- end list -->

  - <span class="c3">Jak zlaté dítě tak černá ovce jsou týrány</span>
  - <span class="c3">I přestože zlaté dítě bylo týráno stejně jako
    obětní beránek, tak zůstává ve své roli namísto toho aby se
    osamostatnilo a prošlo terapií, především kvůli finanční výhodám a
    kvůli vyšší společenské akceptaci udržování vztahu s rodinou ve
    srovnání s odstřižením rodiny ze svého života.</span>

<!-- end list -->

  - <span class="c3">Izolace a triangulace a podpora soupeřivosti mezi
    sourozenci</span>

<!-- end list -->

  - <span class="c3">rodiče typicky děti komunikačně oddělují, nemluví s
    nimi společně, s každým dítětem se baví jinak a říkají jim něco
    jiného.</span>
  - <span class="c3">triangulace je jako vložení klínů mezi dva lidi
    třetí osobou - narcis se snaží získat loajalitu obou stran a
    zároveň usiluje o to, aby spolu obě strany bojovaly. Pro docíleni
    tohoto bude narcis využívat všechny možné druhy komunikační
    manipulace.</span>
  - <span class="c3">rodiče pomocí triangulace generují soupeřivost mezi
    sourozenci, kterou nahrazují sourozeneckou lásku</span>
  - <span class="c3">rodiče často srovnávají děti, jedno shazují a druhé
    vyvyšují, čím zvyšují oboustrannou soupeřivost mezi dětmi</span>
  - <span class="c3">narcis s oblibou trianguluje nejen mezi vlastními
    dětmi, ale často srovnává děti se spolužáky, dalšími dětmi v širší
    rodině apod.</span>
  - <span class="c3">pokud narcistický rodič vidí komunikaci mezi
    sourozenci, snaží se zlaté dítě izolovat. pokud by zlaté dítě
    preferovalo trávit čas se svými sourozenci, přichází narcis o zdroj
    svého potěšení a neskutečně trpí.</span>

<!-- end list -->

  - <span class="c3">Preemtivní útoky</span>

<!-- end list -->

  - <span class="c3">preemptivní útoky jsou běžnou praxí</span>

<!-- end list -->

  - <span class="c3">Manipulace</span>

<!-- end list -->

  - <span class="c3">narcis vytváří prostřednictvím svého narativu
    neexistující problémy ve realitě svých dětí (nebo obecně životech
    druhých lidí), provokuje v nich emoce strachu, závisti nebo zlosti a
    následně nabízí své zvrácené řešení celé situace</span>

<!-- end list -->

  - <span class="c3">Peníze jako prostředek kontroly</span>

<!-- end list -->

  - <span class="c3">Narcis rodič používá peníze jako nástroj, jako
    páku, jako cukr a bič, jako vodítko, kterým děti uvazuje k
    sobě</span>
  - <span class="c3">Zlaté dítě dostává finanční pomoc, zatímco obětní
    beránek ne.</span>
  - <span class="c3">Narcis si zlaté dítě připoutává prostřednictvím
    dědictví až do své smrti. Obětní beránci typicky dostávají 10.000
    dolarů, zatímco zlaté dítě dostane vše ostatní. Toto je jejich
    finální akt týrání - používají i svou smrt k tomu, aby
    ublížili.</span>

<!-- end list -->

  - <span class="c3">Narcistická alliance</span>

<!-- end list -->

  - <span class="c3">Jakákoliv rodina má tendenci se spolčit proti
    jednomu členovi - psychologicky to dává spolku dobrý pocit.</span>

<!-- end list -->

  - <span class="c3">Rodič narcis může sám oscilovat mezi zneužívajících
    a rozmazlujícím pólem (např. v nejednoznačné návnoznosti na stav
    jeho vlastního narcistního uspokojení) a takto vytvořit virtuální
    rodičovský mikrovesmír, skrz který přenáší dynamiku rodičovského
    zneužívání na svého partnera a tím ho vnitřně psychologicky
    rozpolcuje tak, že partner postupně přijímá, že někdy je sám jako
    partner dobrý a někdy je špatný</span>

### <span class="c0">Dočasná repolarizace v důsledku snahy zlatého dítěte o samostatnost</span>

  - <span class="c3">v případě tendence zlatého dítěte pro oddálení se,
    resp. přerušení vztahu s narcisem se narcis obrací na jednoho z
    obětních beránků (nic jiného jim nezbývá - kontakt se zlatým
    dítětem byl přerušen a narcis potřebuje nakrmit), jakoby se mezi
    nima nikdy nic nestalo a začne se jej snažit přetvářet ve zlaté dítě
    (pomocí pozornosti, darů, společného času, finanční podpory...), ale
    to jen proto, aby se mohl dostat zpět do života zlatého
    dítěte</span>
  - <span class="c3">bohužel jakožto vyhladovění po lásce a pozornosti
    se na tento trik nachytáme, zapomínáme nebo odpouštíme</span>
  - <span class="c3">zlaté dítě si po pokusu o oddělení uvědomí, že
    přísun peněz byl zastaven, že neudrží děti na soukromých školách,
    že nemá z čeho zaplatit dluhy z gamblingu, že jsou na všechno
    sami... a znovu navážou kontakt s narcisem. V ten okamžik bude
    původní černá ovce během pár minut opět zavržena.</span>
  - <span class="c3">Narcista je poučen a ví, že nemůže udělat to co
    udělal minule, a musí změnit své chování aby si přísun od dítěte
    udržel.</span>

# <span class="c18">Narcismus a závislosti</span>

## <span class="c11">Závislost obecně</span>

  - <span class="c3">Nikdo není závislý na nějaké látce. Ćlověk je
    závislý na změně nálady, kterou daná látka přináší</span>
  - <span class="c3">Veškeré závislosti jsou reakcí na traumatizující
    dětství - jsou snahou o únik z následného utrpení</span>
  - <span class="c3">Všichni jsme nějak závislí - některé závislosti
    jsou společností akceptované, některé nikoliv - workoholismus,
    závislost na úspěchu, stavění potřeb druhých před své ignorované
    potřeby, potlačování veškeré zlosti, alkoholismus, drogové
    závislosti, závislost na vzrušení</span>
  - <span class="c3">Závislost přichází jako pomoc pro lidi s hlubokými
    emočními problémy, kteří nemají prostředky k tomu, aby své problémy
    samostatně vyřešili</span>
  - <span class="c3">Čím vnímavější a citlivější dítě, tím větší
    schopnost vnímat stres a rozpory mezi rodiči, tím větší
    pravděpodobnost traumatizace</span>
  - <span class="c3">Odmítání bolesti a utrpení v dnešní kultuře je
    jedním z nejzásadnějších faktorů ve vzniku závislosti</span>
  - <span class="c3">Ne všichni traumatizovaní se stanou závislými, ale
    všichni závislí byli a jsou traumatizování</span>
  - <span class="c3">Závislosti začaly vznikat na přelomu 17 a 18
    století, když jsme přestali žít v komunách, začali se stěhovat do
    měst a začali atomizovat společnost do rodin a následně geograficky
    dislokovat jednotlivce pryč z jejich rodných komunit, rodin, hodnot
    apod. Fenomén závislosti je důsledek industrializace a
    globalizace.</span>
  - <span class="c3">opakem závislosti není střízlivost, opakem
    závislosti je spojení s druhými</span>

## <span class="c11">Narcismus jako závislost</span>

  - <span class="c3">narcista je závislý na narcistickém přísunu</span>
  - <span class="c3">narcista konzumuje narcistní zdroje proto aby
    změnil prostředí v sobě, svět venku ho nezajímá</span>

## <span class="c11">Narcismus v kontextu běžných závislostí</span>

### <span class="c0">Potřeba závislosti / Důvodu závislosti</span>

<span class="c6">Primární</span>

  - <span class="c3">Závislost pomáhá přemostit prostor mezi falešným a
    skutečným já a uvolnit úzkost plynoucí z kontrastu mezi
    nerealistickými očekávaními a realitou</span>
  - <span class="c3">alkohol nám pomáhá cítit se jako středobod zájmu a
    cítit se jako jednička</span>
  - <span class="c3">alkohol nám pomáhá být krutými tím, že nám pomůže
    se zbavit zábran, které nám v krutosti brání</span>
  - <span class="c3">Alkohol pomáhá umlčet pravé já a pomáhá zdůraznit
    falešná já</span>

<span class="c6">Sekundární</span>

  - <span class="c3">narcista se cítí dobře když se věnuje gamblingu,
    nebezpečně řídí apod. a neuvědomuje si, že tyto jeho závislosti jsou
    závislostmi a je přesvědčen, že může kdykoliv skončit</span>
  - <span class="c3">klasická závislost poskytuje narcisovi exoskeleton,
    jakýsi řád a ritual v jinak chaotickém vnějším světě</span>
  - <span class="c3">alkohol umožňuje cerebrálním narcisům demonstrovat
    znalosti v doméně alkoholických nápojů, a pro somatické narcisty je
    přirozenou součástí jejich loveckého teritoria - noční kluby,
    večírky apod.</span>

### <span>Narcismus umo</span> <span>ž</span> <span class="c0">ňuje závislost</span>

  - <span class="c3">narcis staví své potřeby vždy před potřeby všech
    ostatních</span>
  - <span class="c3">narcis si nikdy nepřizná své sobecké chování, bude
    vinit ostatní jako příčinu</span>
  - <span class="c3">nedostatek odpovědnosti nám umožňuje pít kdekoliv,
    kdykoliv, s kýmkoliv bez ohledu na konvence, pravidla atd.</span>

### <span class="c0">Vztah narcismu a závislosti</span>

  - <span class="c3">Závislosti jsou pro NPD velmi typické</span>
  - <span class="c3">více než polovina diagnostikovaných NPD jsou
    alkoholici nebo jinak závislí</span>
  - <span class="c3">psychopati mají vysoké novelty seeking a risk
    taking skore a mnoho z nich bere alkohol a drogy</span>
  - <span class="c3">jen mala cast zavislych na drogach a alkoholu je
    vsak psychopaty</span>
  - <span class="c3">Tendence k závislosti na internetu - naplňuje mnoho
    narcistických potřeb, avšak typický narcista potřebuje lidský
    kontakt a často se od internetu vzdaluje</span>

### <span class="c0">Rozdíly mezi neutorypickým závislým a závislým narcisem</span>

  - <span class="c3">Narcis svou závislost racionalizuje pokud je
    přistižen - dělá výzkum, uvolňuje ho to, zvyšuje si tak kreativitu
    apod.</span>
  - <span class="c3">narcistické magické myšlení spěje k přesvědčení, že
    na rozdíl od normálních lidí my alkohol zvládneme</span>
  - <span class="c3">narcisté se stávají závislými, protože se vnímají
    jako výjimeční a nadřazení, mohou si to tedy dovolit, dokáží to
    ovládnout atd.</span>
  - <span class="c3">statistiky nebezpečnosti drog jsou pro narcisty
    irelevantní, protože se nadřazují nad ostatní a jsou přesvědčeni o
    tom, že pro ně statistika neplatí</span>
  - <span class="c3">stud je jeden z příčinných faktorů, který je stejný
    jak u narcismu tak u závislosti</span>
  - <span class="c3">život s alkoholikem má naději na zlepšení, život s
    narcisem naději na zlepšení nemá, i kdyby narcis přestal pít, tak
    zůstane narcisem. </span>
  - <span class="c3">mnoho partnerů nenarcistických alkoholiků nemá
    problém s alkoholismem partnera, dokonce přiznává, že jejich vztah
    je bez alkoholu horší než s alkoholem</span>
  - <span class="c3">klasická závislost nihilistická a sebezničující.
    závislost narice je restorativní pud sebezáchovy připravující
    narcise na další úsilí zajištění narcisistních zdrojů</span>

### <span class="c0">Pomoc závislému narcisovi</span>

  - <span class="c3">je jen málo věcí, kterými lze pomoci závislému nebo
    narcisovi, pokud je závislý narcis, je toho ještě méně</span>
  - <span class="c3">tradiční terapie závislosti pro narcisty nefungují,
    protože fungují jen pro ty, co si skutečně dokáží přiznat že mají
    problém, což narcista nikdy vnitně neudělá, přestože může navenek
    hrát jako by to udělal</span>
  - <span class="c3">klíčem pro zbavení se závislosti je vytvořit si
    život s dostatečným odstupem od dané závislosti a dostatkem jiných
    zdrojů zábavy a potěšení. to však narcista nikdy neudělá, očekává,
    že toto pro něj mají zařídit a zajišťovat druzí</span>
  - <span class="c3">abychom neumožňovali a nepodporovali závislého, je
    třeba přestat tuto závislost skrývat a závislého tak chránit</span>
  - <span class="c3">nedávejte narcisovi finanční pomoc přímo, ale
    plaťte za něj to, s čím jim chcete pomoc</span>

### <span class="c0">Abstinence a replasy</span>

  - <span class="c3">Relaps je téměř zaručen - narcis se typicky
    přesvědčí, že když se zvládl napít a přestat v minulosti sám bez
    pomoci ostatních, zvládne to opět a znova</span>
  - <span class="c3">narcista může přiznat, že alkohol je pro něj
    problém, avšak né proto jak se chová k druhým když je opilý, ne
    protože jim přebíjí své emoce, ne protože konstantě vyhledává a
    nemůže být bez hedonistického potěšení bez ohledu na ostatní.
    Jediný důvod typicky bývá obdoba toho, že alkohol je špatný pro jeho
    zdraví a stojí ho to jeho peníze nebo díky tomu musí chodit k soudům
    a do vězení, takže by s tím mohl někdy mohl přestat.</span>
  - <span class="c3">narcistní mačkání tlačítka reset - když narcista
    alkoholik začne posílat emoční dopisy apod, o tom jak mu chybíte atd
    bez jakéhokoliv přiznávání si vlastní viny atd</span>

# <span class="c18">Soužití s narcisem</span>

### <span class="c0">Strategie pro život s narcisem</span>

  - <span class="c3">eliminace veškerého kontaktu</span>
  - <span class="c3">manipulace přísunu</span>
  - <span class="c3">koluze - spolčení se s narcisem proti někomu
    dalšímu, čímž dojde k minimalizaci ubližování společnému</span>
  - <span class="c3">submise - souhlasení s jeho názory, dávání
    pozornosti a uctívání</span>

### <span class="c0">Odplata</span>

  - <span class="c3">nejlepší odplata je dobrý život</span>

### <span class="c0">Problematická chování</span>

  - <span class="c3">rozdíl mezi normálním a problematickým chováním je
    ten, že problematické se dlouhodobě stále opakuje</span>

# <span class="c18">Ostatní</span>

### <span class="c0">Navazování vztahů</span>

  - <span class="c3">červené kontrolky vždycky svítí pokud člověk ví co
    hledat</span>
  - <span class="c3">hlavní nástroj destruktivních osobností je izolace
      - je třeba člověka poznat v okruhu přátel, jeho i svých</span>
  - <span class="c3">intimní vztahy je třeba posouvat velmi pomalu, i v
    případě, že druhého člověka znáte z přátelského vztahu už
    dlouho</span>
  - <span class="c3">první měsíc vztahu bez sexu dokud si neuděláme
    dobrý obrázek člověka bez sexu - normální zdravý člověk s tímto
    musí být o</span>

### <span class="c0">Terapie narcisticky týraných dětí</span>

  - <span class="c3">ti co přežili narcistické týrání potřebuji
    specifické nástroje - nástroje používané pro lidi v depresi a stresu
    nejsou dostatečné</span>
  - <span class="c3">je třeba si připomínat, že i přestože ztráta vztahu
    se sourozencem je nejsmutnější dopad narcistického rodičovství, že
    tohle není Tvoje vina, ale volba sourozence</span>
  - <span class="c3">když narcista vyhazuje dítě z domova, je to protože
    není schopen vystát sebe</span>
  - <span class="c3">když narcista mlátí dítě, mlátí sám sebe</span>
  - <span class="c3">když narcist lže, tak prostě skrývají své
    nedostatky a budují své falešné já</span>
  - <span class="c3">jako černá ovce jsi byl vybrán především pro své
    dobré kvality a kontrast mezi Tebou a vnitřní prázdnotou v
    narcisovi</span>
  - <span class="c3">je třeba přestat mrhat energií na snahu poučit
    sourozence a tím krmit jejich narcistické potřeby a místo toho se
    zaměřit na sebe a své zotavení</span>
  - <span class="c3">často jediné řešení je akceptovat, že prostě
    nebudeš mít rodinu, protože zbytek rodiny terparii nechce (a
    rozhodně ne od tebe), takže je třeba tento neřešitelný úkol nechat
    být</span>
  - <span class="c3">asi jen tak svobodu nezískáš, možná jí v tomto
    životě nikdy plně nezískáš, ale momenty svobody jsou rozhodně
    dosažitelné</span>
  - <span class="c3">pamatuj, kde máš své hranice a uvědomuj si, že když
    Tě někdo týrá, tak je třeba si jen uvědomit, že jsi týraný, ale není
    třeba na to reagovat jakkoliv jinak. pokud se však cítíš naštvaný
    nebo smutný nebo vinný, tak je třeba si to přiznat a procítit s
    vědomím toho, že jsme týraní.</span>
  - <span class="c3">Je třeba se naučit asertivitu a stanovení osobních
    hranic, což v dětství nebylo umožněno.</span>
  - <span class="c3">jakožto obětní beránek jsi neudělal nic špatného,
    jsi jen obětí narcistického rodičovství</span>

### <span class="c0">Střízlivý pohled na rodinné vztahy</span>

  - <span class="c3">Rodič Tě může milovat, to ale neznamená, že Tě
    zároveň nemůže nenávidět</span>
  - <span class="c3">rodina 9 z 10 ti případů rozhodně nechce, to co je
    pro tebe nejlepší, to je mýtus. to co je nejlepší pro tebe je často
    to co je nejhorší pro ně. rozdíl mezi jejich tvrzením a skutečným
    chováním je pak to, co tvoří mentální problémy. rodina chce typicko
    to, co je nejbezpečnější pro ně, nejbezpečnější pro tebe, a z čeho
    budou mít oni dobrý pocit</span>
  - <span class="c3">většina rodin je nemocných, vzájemně se
    vyčerpávajících a vzájemně spolu válčících, je to normální</span>
  - <span class="c3">chování členů v dysfunkční rodině je instinktivní a
    podvědomé, málokdy uvědomělé a promyšlené</span>
  - <span class="c3">i pokud se změníte a bude všude ve svém životě
    demonstrovat, že jste se změnili, tak s Tvou rodinou to nic nezmění,
    budou Tě stále shazovat, ponižovat, ignorovat…</span>
