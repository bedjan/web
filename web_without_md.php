...
html {width: 99%;}
.stranka {width: 99%;border-radius: 10px; background: #FFFFFF}
.logo {float: left; width: 8%;border-radius: 10px; background: #FFFFFF}
.menu {float: left; width: 91%; border-radius: 10px; background: #000000}
.menu * {color: #FFFFFF}
.obsah {float: left; width: 99%;border-radius: 10px; background: #000000}
.obsah * {color: #FFFFFF}
.paticka {float: left;width: 99%;border-radius: 10px; background: #000000}
